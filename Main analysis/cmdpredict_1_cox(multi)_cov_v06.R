...
# --- Load Data ---
  df <- read_dta("05. Result/cmdpredict_python_v04.dta")
...
# Save output
  # All data
  output_data <- file.path(intermediate_data, "cox(multi)_cov_df_v06.rds")
  saveRDS(df_selected, file = output_data)
  
  # Fold indices
  output_fold <- file.path(intermediate_data, "cox(multi)_cov_fold_v06.rds")
