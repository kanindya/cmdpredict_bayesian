...
# --- Define Input File ---
  ...
  input <- file.path(intermediate_data, "logit(any)_cov_cvresult_v06.rds") # From Script 2
...
ggsave(filename = "07. Graph/03. Paper 3/logit(any)_cov(1)_v06.png",
       plot = cal_plot,
...
# Save
ggsave("07. Graph/03. Paper 3/logit(any)_cov(2)_v06.png",
