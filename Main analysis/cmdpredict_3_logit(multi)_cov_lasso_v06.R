...
input <- file.path(intermediate_data, "logit(multi)_cov_lasso_cvresult_v06.rds")
...
if (!is.null(roc_obj) && inherits(roc_obj, "roc")) {
  ...
  roc_plot <- ggroc(roc_obj, colour = 'darkblue', size = 1) +
    ...
    coord_fixed()
  print(roc_plot)
  roc_plot_filename <- "07. Graph/03. Paper 3/logit(multi)_cov_lasso_ROC_v06.png"
...
ggsave(filename = "07. Graph/03. Paper 3/logit(multi)_cov_lasso(1)_v06.png",
       plot = cal_plot,
...
# Save
ggsave("07. Graph/03. Paper 3/logit(multi)_cov_lasso(2)_v06.png",
