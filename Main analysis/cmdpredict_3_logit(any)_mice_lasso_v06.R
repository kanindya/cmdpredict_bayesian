  ...
  # --- Define Input File ---
    ...
    input <- file.path(intermediate_data, "logit(any)_mice_lasso_cvresult_v05.rds") # From Script 2
  ...
  ggsave(filename = "07. Graph/03. Paper 3/logit(any)_mice_lasso(1)_v06.png.png",
         plot = cal_plot,
  ...
  # Save
  ggsave("07. Graph/03. Paper 3/logit(any)_mice_lasso(2)_v06.png",
