...
input_data <- file.path(intermediate_data, "logit(multi)_mice_df_v06.rds") 
input_fold <- file.path(intermediate_data, "logit(multi)_mice_fold_v06.rds") 
output_result <- file.path(intermediate_data, "logit(multi)_mice_lasso_cvresult_v06.rds") 
