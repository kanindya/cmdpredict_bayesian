...
#         *** MODIFIED TO BE REPLICABLE FOR ANY SINGLE INTERACTION ***
...
output_result <- file.path(intermediate_data, paste0("logit(any)_cov_lasso_cvresult_v06_", output_file, ".rds"))
