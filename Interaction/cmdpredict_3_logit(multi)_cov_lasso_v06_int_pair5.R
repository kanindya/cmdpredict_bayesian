...
input <- file.path(intermediate_data, "logit(multi)_lasso_cvresult_v06_int_pair5.rds")
...
if (!is.null(roc_obj) && inherits(roc_obj, "roc")) {
  ...
  roc_plot <- ggroc(roc_obj, colour = 'darkblue', size = 1) +
    ...
    coord_fixed()
  print(roc_plot)
  roc_plot_filename <- "07. Graph/03. Paper 3/logit(multi)_int_pair5_lasso_ROC_v06.png"
...
ggsave(filename = "07. Graph/03. Paper 3/logit(multi)_int_pair5_lasso_v06.png",
       plot = cal_plot,
...
ggsave(filename = "07. Graph/03. Paper 3/logit(multi)_int_pair5_lasso(1)_v06.png",
       plot = cal_plot,
       width = 7, height = 5, units = "in", dpi = 300)
print("Calibration plot saved.")
...
# Save
ggsave("07. Graph/03. Paper 3/logit(multi)_int_pair5_lasso(2)_v06.png",
